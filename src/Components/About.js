...
export default function About(props) {
  ...
  return (
    <div className='container'style={{backgroundColor: props.Mode ==='light'?'white':'black',color:props.Mode ==='light'?'black':'white'}} ><h1>ABOUT</h1><div className="accordion"  id="accordionExample">
    <div className="accordion-item"style={{backgroundColor: props.Mode ==='light'?'white':'black',color:props.Mode ==='light'?'black':'white'}} >
      ...
      <div id="collapseOne" className="ac collapse show" data-bs-parent="#accordionExample">
    ...
    <div className="accordion-item"style={{backgroundColor: props.Mode ==='light'?'white':'black',color:props.Mode ==='light'?'black':'white'}}>
      ...
      <div id="collapseTwo" className="ac collapse" data-bs-parent="#accordionExample">
        <div className="accordion-body" >
    ...
    <div className="accordion-item"style={{backgroundColor: props.Mode ==='light'?'white':'black',color:props.Mode ==='light'?'black':'white'}}>
      ...
      <div id="collapseThree" className="ac collapse" data-bs-parent="#accordionExample">
        <div className="accordion-body">
